...
st.write("Dit dashboard is een uitbreiding op Casus 1 van het begin van de minor. Deze leek de meest logische keuzen gezien toen nog niet actief gewerkt werd met streamlit.")
